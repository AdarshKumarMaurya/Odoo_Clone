...
import img3 from "../img/ProfilePhoto/Adarsh.JPG";
import img4 from "../img/ProfilePhoto/AdarshHackz.jpg";
import img5 from "../img/ProfilePhoto/Aditya.jpg";
import img6 from "../img/ProfilePhoto/Vimalesh.jpg";
import img7 from "../img/ProfilePhoto/Aman.jpg";
import img8 from "../img/ProfilePhoto/Pawan.jpg";
...
export default function ChatBot() {
  ...
  const arr = [
    { img: img1, name: "Riya Singh", position: "Technical Expert" },
    { img: img2, name: "Tanu Panchal", position: "HR Recruiter" },
    { img: img3, name: "Adarsh Maurya", position: "Former CEO of SAP" },
    { img: img4, name: "Adarsh Maurya", position: "Web Developer" },
    { img: img5, name: "Vimalesh Kumar", position: "Customer Support Representative" },
    { img: img6, name: "Aditya Kumar", position: "Software Developer" },
    { img: img7, name: "Adarsh Maurya", position: "Marketing Specialist" },
    { img: img8, name: "Zuveriya Pathan", position: "Sales Manager" },
    { img: img4, name: "Adarsh Hackz", position: "Web Developer" },
    { img: img4, name: "Adarsh Hackz", position: "Web Developer" },
  ];
